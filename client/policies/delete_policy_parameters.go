...
// WithXAnchoreAccount adds the xAnchoreAccount to the delete policy params
func (o *DeletePolicyParams) WithXAnchoreAccount(xAnchoreAccount *string) *DeletePolicyParams {
	o.SetXAnchoreAccount(xAnchoreAccount)
	return o
}

// SetXAnchoreAccount adds the xAnchoreAccount to the delete policy params
func (o *DeletePolicyParams) SetXAnchoreAccount(xAnchoreAccount *string) {
