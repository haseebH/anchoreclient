...
type UpdatePolicyParams struct {
	...
	*/
	Active *bool
	/*Bundle*/
	Bundle *models.PolicyBundleRecord
	/*PolicyID*/
	PolicyID string
	/*XAnchoreAccount
...
// WithActive adds the active to the update policy params
func (o *UpdatePolicyParams) WithActive(active *bool) *UpdatePolicyParams {
	o.SetActive(active)
	return o
}

// SetActive adds the active to the update policy params
func (o *UpdatePolicyParams) SetActive(active *bool) {
	o.Active = active
}

// WithBundle adds the bundle to the update policy params
func (o *UpdatePolicyParams) WithBundle(bundle *models.PolicyBundleRecord) *UpdatePolicyParams {
	o.SetBundle(bundle)
	return o
}

// SetBundle adds the bundle to the update policy params
func (o *UpdatePolicyParams) SetBundle(bundle *models.PolicyBundleRecord) {
	o.Bundle = bundle
}
...
// WithXAnchoreAccount adds the xAnchoreAccount to the update policy params
func (o *UpdatePolicyParams) WithXAnchoreAccount(xAnchoreAccount *string) *UpdatePolicyParams {
	o.SetXAnchoreAccount(xAnchoreAccount)
	return o
}

// SetXAnchoreAccount adds the xAnchoreAccount to the update policy params
func (o *UpdatePolicyParams) SetXAnchoreAccount(xAnchoreAccount *string) {
