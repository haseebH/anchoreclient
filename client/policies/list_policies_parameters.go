...
// WithXAnchoreAccount adds the xAnchoreAccount to the list policies params
func (o *ListPoliciesParams) WithXAnchoreAccount(xAnchoreAccount *string) *ListPoliciesParams {
	o.SetXAnchoreAccount(xAnchoreAccount)
	return o
}

// SetXAnchoreAccount adds the xAnchoreAccount to the list policies params
func (o *ListPoliciesParams) SetXAnchoreAccount(xAnchoreAccount *string) {
