...
// WithAccountname adds the accountname to the create user params
func (o *CreateUserParams) WithAccountname(accountname string) *CreateUserParams {
	o.SetAccountname(accountname)
	return o
}

// SetAccountname adds the accountname to the create user params
func (o *CreateUserParams) SetAccountname(accountname string) {
	o.Accountname = accountname
}

// WithUser adds the user to the create user params
func (o *CreateUserParams) WithUser(user *models.UserCreationRequest) *CreateUserParams {
	o.SetUser(user)
	return o
}

// SetUser adds the user to the create user params
func (o *CreateUserParams) SetUser(user *models.UserCreationRequest) {
	o.User = user
}
