...
// WithAccountname adds the accountname to the delete account params
func (o *DeleteAccountParams) WithAccountname(accountname string) *DeleteAccountParams {
	o.SetAccountname(accountname)
	return o
}

// SetAccountname adds the accountname to the delete account params
func (o *DeleteAccountParams) SetAccountname(accountname string) {
