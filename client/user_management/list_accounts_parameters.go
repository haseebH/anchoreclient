...
// WithState adds the state to the list accounts params
func (o *ListAccountsParams) WithState(state *string) *ListAccountsParams {
	o.SetState(state)
	return o
}

// SetState adds the state to the list accounts params
func (o *ListAccountsParams) SetState(state *string) {
	o.State = state
}
