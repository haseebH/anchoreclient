...
// WithAccountname adds the accountname to the get account params
func (o *GetAccountParams) WithAccountname(accountname string) *GetAccountParams {
	o.SetAccountname(accountname)
	return o
}

// SetAccountname adds the accountname to the get account params
func (o *GetAccountParams) SetAccountname(accountname string) {
