...
// WithAccountname adds the accountname to the delete user params
func (o *DeleteUserParams) WithAccountname(accountname string) *DeleteUserParams {
	o.SetAccountname(accountname)
	return o
}

// SetAccountname adds the accountname to the delete user params
func (o *DeleteUserParams) SetAccountname(accountname string) {
