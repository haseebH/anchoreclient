...
type CreateAccountParams struct {
	...
	/*Account*/
	Account *models.AccountCreationRequest
...
func (o *CreateAccountParams) WithAccount(account *models.AccountCreationRequest) *CreateAccountParams {
	o.SetAccount(account)
	return o
}

// SetAccount adds the account to the create account params
func (o *CreateAccountParams) SetAccount(account *models.AccountCreationRequest) {
	o.Account = account
}
