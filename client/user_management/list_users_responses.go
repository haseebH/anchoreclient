...
func (o *ListUsersOK) Error() string {
	return fmt.Sprintf("[GET /accounts/{accountname}/users][%d] listUsersOK  %+v", 200, o.Payload)
}
...
func (o *ListUsersInternalServerError) Error() string {
	return fmt.Sprintf("[GET /accounts/{accountname}/users][%d] listUsersInternalServerError  %+v", 500, o.Payload)
}

func (o *ListUsersInternalServerError) GetPayload() *models.APIErrorResponse {
	return o.Payload
}
