...
// WithXAnchoreAccount adds the xAnchoreAccount to the delete subscription params
func (o *DeleteSubscriptionParams) WithXAnchoreAccount(xAnchoreAccount *string) *DeleteSubscriptionParams {
	o.SetXAnchoreAccount(xAnchoreAccount)
	return o
}

// SetXAnchoreAccount adds the xAnchoreAccount to the delete subscription params
func (o *DeleteSubscriptionParams) SetXAnchoreAccount(xAnchoreAccount *string) {
