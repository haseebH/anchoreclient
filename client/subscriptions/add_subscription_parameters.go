...
// WithXAnchoreAccount adds the xAnchoreAccount to the add subscription params
func (o *AddSubscriptionParams) WithXAnchoreAccount(xAnchoreAccount *string) *AddSubscriptionParams {
	o.SetXAnchoreAccount(xAnchoreAccount)
	return o
}

// SetXAnchoreAccount adds the xAnchoreAccount to the add subscription params
func (o *AddSubscriptionParams) SetXAnchoreAccount(xAnchoreAccount *string) {
