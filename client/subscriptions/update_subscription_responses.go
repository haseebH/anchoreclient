...
func (o *UpdateSubscriptionOK) Error() string {
	return fmt.Sprintf("[PUT /subscriptions/{subscriptionId}][%d] updateSubscriptionOK  %+v", 200, o.Payload)
}

func (o *UpdateSubscriptionOK) GetPayload() models.SubscriptionList {
	return o.Payload
}
