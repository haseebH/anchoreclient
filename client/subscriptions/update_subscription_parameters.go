...
type UpdateSubscriptionParams struct {
	...
	/*Subscription*/
	Subscription *models.SubscriptionUpdate
	/*SubscriptionID*/
...
func (o *UpdateSubscriptionParams) WithSubscription(subscription *models.SubscriptionUpdate) *UpdateSubscriptionParams {
	o.SetSubscription(subscription)
	return o
}

// SetSubscription adds the subscription to the update subscription params
func (o *UpdateSubscriptionParams) SetSubscription(subscription *models.SubscriptionUpdate) {
...
// WithXAnchoreAccount adds the xAnchoreAccount to the update subscription params
func (o *UpdateSubscriptionParams) WithXAnchoreAccount(xAnchoreAccount *string) *UpdateSubscriptionParams {
	o.SetXAnchoreAccount(xAnchoreAccount)
	return o
}

// SetXAnchoreAccount adds the xAnchoreAccount to the update subscription params
func (o *UpdateSubscriptionParams) SetXAnchoreAccount(xAnchoreAccount *string) {
