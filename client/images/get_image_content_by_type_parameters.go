...
// WithXAnchoreAccount adds the xAnchoreAccount to the get image content by type params
func (o *GetImageContentByTypeParams) WithXAnchoreAccount(xAnchoreAccount *string) *GetImageContentByTypeParams {
	o.SetXAnchoreAccount(xAnchoreAccount)
	return o
}

// SetXAnchoreAccount adds the xAnchoreAccount to the get image content by type params
func (o *GetImageContentByTypeParams) SetXAnchoreAccount(xAnchoreAccount *string) {
