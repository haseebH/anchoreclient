...
// WithFulltag adds the fulltag to the list images params
func (o *ListImagesParams) WithFulltag(fulltag *string) *ListImagesParams {
	o.SetFulltag(fulltag)
	return o
}

// SetFulltag adds the fulltag to the list images params
func (o *ListImagesParams) SetFulltag(fulltag *string) {
	o.Fulltag = fulltag
}
...
// WithXAnchoreAccount adds the xAnchoreAccount to the list images params
func (o *ListImagesParams) WithXAnchoreAccount(xAnchoreAccount *string) *ListImagesParams {
	o.SetXAnchoreAccount(xAnchoreAccount)
	return o
}

// SetXAnchoreAccount adds the xAnchoreAccount to the list images params
func (o *ListImagesParams) SetXAnchoreAccount(xAnchoreAccount *string) {
...
func (o *ListImagesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Fulltag != nil {
		...
		// query param fulltag
		var qrFulltag string
		if o.Fulltag != nil {
			qrFulltag = *o.Fulltag
		}
		qFulltag := qrFulltag
		if qFulltag != "" {
			if err := r.SetQueryParam("fulltag", qFulltag); err != nil {
				return err
			}
		}
