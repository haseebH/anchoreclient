...
// WithXAnchoreAccount adds the xAnchoreAccount to the get image content by type image Id params
func (o *GetImageContentByTypeImageIDParams) WithXAnchoreAccount(xAnchoreAccount *string) *GetImageContentByTypeImageIDParams {
	o.SetXAnchoreAccount(xAnchoreAccount)
	return o
}

// SetXAnchoreAccount adds the xAnchoreAccount to the get image content by type image Id params
func (o *GetImageContentByTypeImageIDParams) SetXAnchoreAccount(xAnchoreAccount *string) {
