...
type GetImageContentByTypeImageIDOK struct {
	Payload *models.ContentPackageResponse
}
...
func (o *GetImageContentByTypeImageIDOK) GetPayload() *models.ContentPackageResponse {
	return o.Payload
}
...
func (o *GetImageContentByTypeImageIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ContentPackageResponse)
...
func (o *GetImageContentByTypeImageIDInternalServerError) GetPayload() *models.APIErrorResponse {
	return o.Payload
}
