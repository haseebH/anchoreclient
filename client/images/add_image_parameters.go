...
// WithXAnchoreAccount adds the xAnchoreAccount to the add image params
func (o *AddImageParams) WithXAnchoreAccount(xAnchoreAccount *string) *AddImageParams {
	o.SetXAnchoreAccount(xAnchoreAccount)
	return o
}

// SetXAnchoreAccount adds the xAnchoreAccount to the add image params
func (o *AddImageParams) SetXAnchoreAccount(xAnchoreAccount *string) {
