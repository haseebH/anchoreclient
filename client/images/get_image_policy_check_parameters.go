...
// WithInteractive adds the interactive to the get image policy check params
func (o *GetImagePolicyCheckParams) WithInteractive(interactive *bool) *GetImagePolicyCheckParams {
	o.SetInteractive(interactive)
	return o
}

// SetInteractive adds the interactive to the get image policy check params
func (o *GetImagePolicyCheckParams) SetInteractive(interactive *bool) {
...
// WithXAnchoreAccount adds the xAnchoreAccount to the get image policy check params
func (o *GetImagePolicyCheckParams) WithXAnchoreAccount(xAnchoreAccount *string) *GetImagePolicyCheckParams {
	o.SetXAnchoreAccount(xAnchoreAccount)
	return o
}

// SetXAnchoreAccount adds the xAnchoreAccount to the get image policy check params
func (o *GetImagePolicyCheckParams) SetXAnchoreAccount(xAnchoreAccount *string) {
