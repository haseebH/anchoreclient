...
// WithImageDigest adds the imageDigest to the get image params
func (o *GetImageParams) WithImageDigest(imageDigest string) *GetImageParams {
	o.SetImageDigest(imageDigest)
	return o
}

// SetImageDigest adds the imageDigest to the get image params
func (o *GetImageParams) SetImageDigest(imageDigest string) {
	o.ImageDigest = imageDigest
}

// WithXAnchoreAccount adds the xAnchoreAccount to the get image params
func (o *GetImageParams) WithXAnchoreAccount(xAnchoreAccount *string) *GetImageParams {
	o.SetXAnchoreAccount(xAnchoreAccount)
	return o
}

// SetXAnchoreAccount adds the xAnchoreAccount to the get image params
func (o *GetImageParams) SetXAnchoreAccount(xAnchoreAccount *string) {
