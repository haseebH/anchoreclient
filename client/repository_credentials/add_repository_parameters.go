...
// WithXAnchoreAccount adds the xAnchoreAccount to the add repository params
func (o *AddRepositoryParams) WithXAnchoreAccount(xAnchoreAccount *string) *AddRepositoryParams {
	o.SetXAnchoreAccount(xAnchoreAccount)
	return o
}

// SetXAnchoreAccount adds the xAnchoreAccount to the add repository params
func (o *AddRepositoryParams) SetXAnchoreAccount(xAnchoreAccount *string) {
