...
// WithXAnchoreAccount adds the xAnchoreAccount to the delete registry params
func (o *DeleteRegistryParams) WithXAnchoreAccount(xAnchoreAccount *string) *DeleteRegistryParams {
	o.SetXAnchoreAccount(xAnchoreAccount)
	return o
}

// SetXAnchoreAccount adds the xAnchoreAccount to the delete registry params
func (o *DeleteRegistryParams) SetXAnchoreAccount(xAnchoreAccount *string) {
