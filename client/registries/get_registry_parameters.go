...
// WithXAnchoreAccount adds the xAnchoreAccount to the get registry params
func (o *GetRegistryParams) WithXAnchoreAccount(xAnchoreAccount *string) *GetRegistryParams {
	o.SetXAnchoreAccount(xAnchoreAccount)
	return o
}

// SetXAnchoreAccount adds the xAnchoreAccount to the get registry params
func (o *GetRegistryParams) SetXAnchoreAccount(xAnchoreAccount *string) {
